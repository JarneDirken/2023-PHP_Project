...
class Order extends Model
{
    ...
    public function coupon(){
        return $this->belongsTo(Coupon::class)->withDefault();  // a Order belongs to a Coupon
    }
    public function pointusers(){
        return $this->hasMany(PointUser::class);   // a order has many PointUsers
    }
    public function articleorders(){
        return $this->hasMany(ArticleOrder::class);   // a order has many ArticleOrders
    }
    public function user(){
        return $this->belongsTo(User::class)->withDefault();  // a Order belongs to a User
    }
