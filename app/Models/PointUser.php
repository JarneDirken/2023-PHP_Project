...
class PointUser extends Model
{
    ...
    public function season(){
        return $this->belongsTo(Season::class)->withDefault();  // a PointUser belongs to a season
    }
    public function point(){
        return $this->belongsTo(Point::class)->withDefault();  // a PointUser belongs to a point
    }
    public function user(){
        return $this->belongsTo(User::class)->withDefault();  // a PointUser belongs to a user
    }
    public function order(){
        return $this->belongsTo(Order::class)->withDefault();  // a PointUser belongs to a order
    }
