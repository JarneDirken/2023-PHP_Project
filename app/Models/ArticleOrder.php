...
class ArticleOrder extends Model
{
    ...
    public function order(){
        return $this->belongsTo(Order::class)->withDefault();  // a ArticleOrder belongs to a order
    }
    public function article(){
        return $this->belongsTo(Article::class)->withDefault();  // a ArticleOrder belongs to a article
    }
