...
class Tour extends Model
{
     ...
     */
    protected function presentAmount(): Attribute
    {
        return Attribute::make(
            get: function($value, $attributes) {
                return UserTour::where('tour_id', $attributes['id'])->where('present', true)->count();
            }
        );
    }

    protected $appends = ['present_amount'];
    protected $fillable = ['name', 'date', 'departure_time', 'distance', 'team_id','user_id','description','location'];
